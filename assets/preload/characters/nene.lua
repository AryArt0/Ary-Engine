...
function onCreate()
	...
	makeLuaSprite('abotEyeBack', 'empty', getProperty('gf.x') -120, getProperty('gf.y') +430);
	makeGraphic('abotEyeBack', 110, 70, 'FFFFFF');

	makeAnimatedLuaSprite('abotEyes', 'characters/abot/systemEyes', getProperty('gf.x') -76, getProperty('gf.y') +285)
	addAnimationByPrefix('abotEyes', 'l', 'Left', 24, false)
	addAnimationByPrefix('abotEyes', 'r', 'Right', 24, false)

	makeLuaSprite('abotBG', 'characters/abot/stereoBG', getProperty('gf.x') -22, getProperty('gf.y') +198);
	scaleObject('abotBG', 1.05, 1.05);

	makeAnimatedLuaSprite('abotViz1', 'aBotViz', getProperty('gf.x') +26, getProperty('gf.y') +270);
	...
	makeAnimatedLuaSprite('abotViz2', 'aBotViz', getProperty('gf.x') +88, getProperty('gf.y') +263);
	...
	makeAnimatedLuaSprite('abotViz3', 'aBotViz', getProperty('gf.x') +145, getProperty('gf.y') +260);
	...
	makeAnimatedLuaSprite('abotViz4', 'aBotViz', getProperty('gf.x') +211, getProperty('gf.y') +260);
	...
	makeAnimatedLuaSprite('abotViz5', 'aBotViz', getProperty('gf.x') +268, getProperty('gf.y') +260);
	...
	makeAnimatedLuaSprite('abotViz6', 'aBotViz', getProperty('gf.x') +324, getProperty('gf.y') +265);
	...
	makeAnimatedLuaSprite('abotViz7', 'aBotViz', getProperty('gf.x') +376, getProperty('gf.y') +273);
	...
	makeAnimatedLuaSprite('abot', 'characters/abot/abotSystem', getProperty('gf.x') -175, getProperty('gf.y') +190)
...
function onTimerCompleted(tag, loops, loopsLeft)
	if tag == 'abotEyesLeft1' and abotEyes == 1 then
		abotEyes = 0
		playAnim('abotEyes', 'l');
		doTweenX("abotEyesX", 'abotEyes', getProperty('gf.x') -136, 0.1, 'cubeOut')
		doTweenY("abotEyesY", 'abotEyes', getProperty('gf.y') +432, 0.1, 'cubeOut')
	end
	if tag == 'abotEyesRight1' and abotEyes == 0 then
		abotEyes = 1
		playAnim('abotEyes', 'r');
		doTweenX("abotEyesX", 'abotEyes', getProperty('gf.x') -116, 0.1, 'cubeOut')
		doTweenY("abotEyesY", 'abotEyes', getProperty('gf.y') +429, 0.1, 'cubeOut')
	end
end
